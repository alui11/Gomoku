...
for iRow = 1:15
    for iCol = 1:15
        if board(iRow, iCol) == 1
            ...
            check1(coutner).column = iCol;
            check2(counter).row = iRow;
            check2(coutner).column = iCol;
            check3(counter).row = iRow;
            check3(coutner).column = iCol;
            check4(counter).row = iRow;
            check4(coutner).column = iCol;
            %forward
            if iCol <= 11 && iCol >= 2
            ...
            elseif iCol == 13
                check1(counter).vector = [board(iRow, iCol-1:iCol+3), 2, 2];
            elseif iCol == 1
