...
% 120220
% 122020
closedFours = {[0 2 2 2 0 1], [0 2 0 2 2 1], [0 2 2 0 2 1],...
    [1 2 2 2 0 0], [1 2 0 2 2 0], [1 2 2 0 2 0]};

% maybe: (need 1 zero)
% 022212
% 022210
% 022211
fourAddZero = {[0 2 2 2 1 2], [0 2 2 2 1 0], [0 2 2 2 1 1]};

% Possible open 3s
% 020200
% 022000
% 020020
openThrees = {[0 2 0 2 0 0], [0 2 2 0 0 0], [0 2 0 0 2 0]};
...
% 022002
% 020202
threeAddZero = {[0 2 0 2 0 1], [0 2 2 0 0 1], [0 2 2 0 0 2],...
    [0 2 0 2 0 2]};
...
% 022012
% 022010
threeAdd2Zeros = {[0 2 2 0 1 1], [0 2 2 0 2 1], [0 2 2 0 1 2],...
    [0 2 2 0 1 0]};
...
for iRow = 1:15
    for iCol = 1:15
        if board(iRow, iCol) == 2
            ...
            elseif iCol == 12
                check1(counter).vector = [board(iRow, iCol-1:iCol+3), 1];
            elseif iCol == 13
                check1(counter).vector = [board(iRow, iCol-1:iCol+2), 1, 1];
            elseif iCol == 1
                check1(counter).vector = [1, board(iRow, iCol:iCol+4)];
            else
            ...
            elseif iRow == 12
                check2(counter).vector = [board(iRow-1:iRow+3, iCol); 1]';
            elseif iRow == 13
                check2(counter).vector = [board(iRow-1:iRow+2, iCol); 1; 1]';
            elseif iRow == 1
                check2(counter).vector = [1; board(iRow:iRow+4, iCol)]';
            else
            ...
            elseif iRow == 1 && iCol <= 11
                check3(counter).vector = [1, board(iRow,iCol),...
                    board(iRow+1,iCol+1), board(iRow+2,iCol+2),...
                    board(iRow+3,iCol+3), board(iRow+4,iCol+4)];
            elseif iCol == 12 && iRow <= 12 && iRow >= 2
                check3(counter).vector = [board(iRow-1,iCol-1), board(iRow,iCol),...
                    board(iRow+1,iCol+1), board(iRow+2,iCol+2),...
                    board(iRow+3,iCol+3), 1];
            ...
            elseif iRow == 1 && iCol >= 5
                check4(counter).vector = [1, board(iRow,iCol),...
                    board(iRow+1,iCol-1), board(iRow+2,iCol-2),...
                    board(iRow+3,iCol-3), board(iRow+4,iCol-4)];
